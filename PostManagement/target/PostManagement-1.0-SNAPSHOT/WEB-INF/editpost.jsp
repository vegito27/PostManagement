...
<div class="container-contact100" style="background-image: url('images/bg-01.jpg');">
    <div class="wrap-contact100">
        ...
        <form class="contact100-form validate-form" action="editpost.do" method="POST">
				<span class="contact100-form-title">
                    Please Create Your Post Here!!<input type="text" name="postid" style="display:block" value="${id}">
				</span>
            ...
            <div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                ...
                <div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                <span class="label-input100">Title</span>
                <input class="input100" type="text" name="title" placeholder="Title..." value="${p}">
            </div>
            ...
            <div class="wrap-input100 validate-input" data-validate = "Message is required">
                ...
                <textarea class="input100" name="post" placeholder="Your message here..."  >${post}</textarea>
            </div>
